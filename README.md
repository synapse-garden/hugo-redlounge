...
## Xtags and Dart scripts

Xtags should go in `/static/script/xtags/`.  They can be enabled for a
page by setting the `xtags` Param for the page to the name of the .js file
defining the xtags required for the page.
